 ...
 */
public final class FastPathLamportBuffer<E> implements LamportBuffer<E> {
    private int readPosition;
    private int writePosition;
    private final E[] buffer;
    private final Lock lock = new ReentrantLock();

    private FastPathLamportBuffer(E[] buffer) {
        this.buffer = buffer;
    }
    ...
    public static <T> LamportBuffer<T> createBuffer(Class<T> clazz, int bufferSize) {
        ...
        return new FastPathLamportBuffer<>((T[]) Array.newInstance(clazz, bufferSize));
    }
